                ...
                <div className="container grid gap-8 px-6 py-12 mx-auto lg:grid-cols-3">
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:col-span-2 sm:grid-cols-2 ">
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6">
                            ...
                            <p className="mt-2 text-sm text-blue-500">hello@locallink.com</p>
                        </div>
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6">
                            ...
                            <h2 className="mt-4 text-base font-medium text-gray-800 ">Chat to support</h2>
                        ...
                        <div className="p-4 rounded-lg bg-blue-50 md:p-6 ">
                            ...
                            <p className="mt-2 text-sm text-blue-500">+880 100-0000000</p>
                        </div>
                    </div>
                </div>
                <div className="p-5 pb-0 rounded-md">
                    <iframe className="w-full h-40 md:h-96" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7186.364992032077!2d89.24077064133583!3d25.76453500940029!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e32fa032c63065%3A0xf662e8f75413b20d!2sChiklee%20Water%20Park%2C%20Rangpur!5e0!3m2!1sen!2sbd!4v1722755644211!5m2!1sen!2sbd" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </section>
