    ...
    return (
        <footer>
            ...
            <div className="w-full min-h-screen flex items-center justify-center bg-black">
                <div className=" w-full px-4 md:px-20 lg:px-24 text-white flex flex-col">
                    <div className="w-full text-3xl md:text-6xl lg:text-7xl font-bold">
                        <h1 className="w-full ">How can we help you. <br /> get
                            in touch</h1>
                    </div>
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="w-full text-center my-12 text-gray-600">Copyright © {new Date().getFullYear().toString()} Sheikh Mohammad Nazmul H.</p>
                    </div>
                </div>
            </div>
        </footer>
